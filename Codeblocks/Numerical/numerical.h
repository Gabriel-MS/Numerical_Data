...
double fin_diff_1_vec(double x[], double y[])
{
  int size, i;

  size = x.size();

  double y1[size]; //Vector to output first derivatives
...
//Outputs first derivatives in vector
double fin_diff_2_vec(double x[], double y[])
{
  int size, i;

  size = x.size();

  double y2[size]; //Vector to output first derivatives
...
double cspline(double X[], double Y[], double x)
{
  int size, i;
...
double cspline_vec(double X[], double Y[], double x[])
{
  int size, i;
...
double cspline_deriv1(double X[], double Y[], double x)
{
  int size, i;
...
double cspline_deriv1_vec(double X[], double Y[], double x[])
{
  int size, i;
